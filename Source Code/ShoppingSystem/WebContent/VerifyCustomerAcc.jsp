...
<body>
				...
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="#" method="post">
							...
							Hey there
							<%=firstName%>
							<%=lastName%>, Enter the verification code that was sent to your
							email address <br /><br />
							<div class="">
								<input type="text" placeholder="5 digit verification code"
									id="txtVerificationCode" name="message" required="">
							</div>
							<div class="">
								<input class="btn btn-info" type="button"
									onclick="SubmitVerificationCode()" value="Submit">
							</div>
	...
	<script>
		...
		function SubmitVerificationCode() {
			var txtVerificationCode = document
					.getElementById('txtVerificationCode').value;
			...
			$
					.ajax({
						...
						success : function(data) {
							...
							if (data.trim() === "sessionTimeOut") {
								window.location.href = "index.jsp";
							} else if (data.trim() === "Nop!") {
								$
										.toast({
											heading : ':(',
											text : "Wrong verification code, try again!",
											position : 'top-right',
											icon : 'error'
										});
							} else if (data.trim() === "AccActivated!") {
								$
										.toast({
											heading : 'Success',
