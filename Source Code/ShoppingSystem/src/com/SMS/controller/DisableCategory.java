...
/**
 * Servlet implementation class DisableCategory
 */
@WebServlet("/DisableCategory")
public class DisableCategory extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user.disableCategory(Integer.parseInt(categoryId))){
			 out.println("success");
		}
		else {
			out.println("Issue");
